...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between w-full relative rounded-full px-[10px] py-[8px]">
      {/* logo */}
      <img
      ...
      <div className="items-center gap-[10px] flex">
        ...
        <CiMenuFries
          className="text-[1.8rem] mr-1 text-[#424242] cursor-pointer md:hidden flex w-full"
